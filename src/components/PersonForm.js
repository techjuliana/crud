...
const PersonForm = ({ onSave, person = {} }) => {
  ...
  return (
    <Form onSubmit={handleSubmit}>
      ...
      <div>
      <Input placeholder='Idade' type="number" name="age" value={formState.age} onChange={handleChange} />
      ...
      <div>
      <Input type="text" name="cep" placeholder='CEP' value={formState.cep} onChange={handleChange} />
      ...
      <div>
      <Input type="text" placeholder='Rua' name="street" value={formState.street} onChange={handleChange} />
